...
OPENAI_API_KEY = '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'
...
def search_subfeature(description: str):
    ...
    with the highest cosine similarity to the input description using the OpenAI API.
    """
    ...
    for subfeature_index, subfeature_row in subfeatures.iterrows():
        try:
            ...
            similarity = 0  # Default similarity if there's an issue with embeddings
